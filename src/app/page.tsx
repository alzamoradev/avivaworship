      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 pt-24 pb-16 text-center">
          ...
          <p className="text-aviva-text-muted text-lg md:text-xl max-w-2xl mx-auto mb-10">
            Encontrá letras, acordes y tonalidades para tu momento de adoración
          </p>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
          <div className="w-6 h-10 rounded-full border-2 border-aviva-text-muted/50 flex items-start justify-center p-2">
            <div className="w-1.5 h-3 bg-aviva-gold rounded-full animate-pulse" />
          </div>
        </div>
      </section>
